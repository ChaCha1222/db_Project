         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <form class="form-inline my-2 my-lg-0">
                  <div class="login_bt">
                     <ul>
                        <li><a href="login.php"><span class="user_icon"><i class="fa fa-user"
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="banner_taital_main">
                              ...
                              <p class="banner_text">Cicero, written in 45 BC. This book is a treatise on the theory of
                                 ethics, very popular during the Renaissance. The first line of Lorem</p>
                     ...
                     <div class="row">
                        <div class="col-md-4">
                           <div class="service_box">
                              ...
                              <p class="chunks_text">chunks as necessary, making this the first true generator on the
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               <div class="about_text_main">
                  ...
                  <p class="about_text">anything embarrassing hidden in the middle of text. All the Lorem Ipsum
                           ...
                           <div class="box_main">
                              <div class="customer_main">
                                 ...
                                 <div class="customer_right">
                                    <h3 class="customer_name">Giolio Mark <span class="quick_icon"><img
                                             src="images/quick-icon.png"></span></h3>
                                    <p class="enim_text">anything embarrassing hidden in the middle of text. All the
                                       Lorem Ipsum generators on the Internet tend to repeat predefined chunks as
                                       necessary, making this the first true generator on the Internetanything
                        ...
                        <div class="col-md-12">
                           <div class="box_main">
                              <div class="customer_main">
                                 ...
                                 <div class="customer_right">
                                    <h3 class="customer_name">DenoMark <span class="quick_icon"><img
                                             src="images/quick-icon.png"></span></h3>
                                    <p class="enim_text">anything embarrassing hidden in the middle of text. All the
                                       Lorem Ipsum generators on the Internet tend to repeat predefined chunks as
                                       necessary, making this the first true generator on the Internetanything
      ...
      <div class="container">
         ...
         <div class="news_section_2">
            <div class="news_box">
               ...
               <p class="dummy_text">sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                  veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                  irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. sed do
